...
public class Event{
    ...
    public static final String DESCRIPTION_CANT_BE_EMPTY = "Hey, acho que você esqueu de informar" +
            " a descrição do evento.";
    public static final String DESCRIPTION_CANT_BE_GREATER_THAN = "Hey, o máximo de caractéres" +
            " para descrever um evento é de 500 caracteres";
    private static final String LATITUDE_IS_INVALID = "Hey, você inseriu um número inválido, a " +
            "latitude deve ser maior que -90 e menor que 90!";
    ...
    private static final String LONGITUDE_IS_EMPTY = "Hey, você deixou a longitude em branco... " +
            "preenche ela aí vai!";
    private static final String LATITUDE_IS_EMPTY = "Hey, você deixou a longitude em branco... " +
            "preenche ela aí vai!";
    private static final String INVALID_EVALUATION = "Hey, você deve avaliar um evento com " +
            "notas de 1 a 5!";
    public static final String ADDRESS_IS_EMPTY = "Hey, você esqueceu de nos informar o " +
            "endereço do evento!";
    public static final String INVALID_EVENT_DATE = "Hey, você informou uma data errada, " +
            "pay attention guy!";
